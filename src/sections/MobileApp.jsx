...
export default function MobileApp() {
  ...
  return (
    <section className="py-24 bg-slate-50 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 text-left">
            ...
            <h2 className="font-display text-primary mb-6">
              ...
              {appFeatures.map((feat) => {
                ...
                return (
                  <div key={feat.title} className="flex space-x-3 items-start">
                    <div className="p-2.5 rounded-lg bg-white border border-slate-200/50 text-accent-blue shadow-sm flex-shrink-0">
          ...
          <div className="lg:col-span-6 relative flex justify-center items-center">
            ...
            <div className="relative w-64 aspect-[9/19] rounded-[40px] border-[6px] border-slate-800/80 bg-slate-950 shadow-2xl p-2.5 overflow-visible">
              ...
              <motion.div
                ...
                animate="floatY"
                className="absolute top-12 -left-16 glass-card px-3 py-2 rounded-xl shadow-lg border border-slate-200/50 flex items-center space-x-2.5 pointer-events-none"
              >
                <div className="p-1.5 rounded-lg bg-accent-cyan/10 text-accent-cyan">
                  <Sparkles className="w-4 h-4" />
                </div>
                <div>
                  <h5 className="text-[10px] font-bold text-slate-800">B2B Meeting</h5>
              ...
              <motion.div
                ...
                className="absolute bottom-20 -right-16 glass-card px-3 py-2.5 rounded-xl shadow-lg border border-slate-200/50 flex items-center space-x-2.5 pointer-events-none"
              >
                <div className="p-1.5 rounded-lg bg-green-500/10 text-green-500">
                  <Award className="w-4 h-4" />
                </div>
                <div>
                  <h5 className="text-[10px] font-bold text-slate-800">Certificate Ready</h5>

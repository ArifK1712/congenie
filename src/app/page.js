...
export default function Home() {
  return (
    <div className="w-full relative">
      ...
      <section className="py-16 lg:py-20 bg-white transition-colors duration-300 w-full overflow-hidden relative">
        ...
        <div className="max-w-[1400px] mx-auto px-4 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="mt-4 text-slate-555 leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="relative mt-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
              ...
              <div className="group relative rounded-3xl p-[1px] bg-gradient-to-br from-accent-purple to-accent-blue shadow-lg shadow-accent-purple/5 transition-all duration-300">
                <div className="h-full bg-white/90 backdrop-blur-md rounded-[23px] p-6 sm:p-8 flex flex-col justify-between text-left space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="p-3 rounded-2xl bg-accent-purple/10 text-accent-purple border border-accent-purple/20">
                        <CalendarRange className="w-6 h-6" />
                      </div>
                      <span className="font-mono text-xs font-bold text-slate-400 tracking-wider">STAGE 01</span>
                    </div>

                    <h5 className="font-display text-primary group-hover:text-accent-purple transition-colors">
                      Pre-Event Setup & Sales
                    </h5>
                    <p className="text-slate-555 font-light leading-relaxed">
                  ...
                  <div className="border border-slate-100 rounded-2xl bg-white p-4 font-mono text-[10px] space-y-2.5">
                    <div className="flex justify-between items-center text-slate-450 border-b border-slate-200/50 pb-1.5">
                    ...
                    <div className="space-y-2 text-slate-705">
                      <div className="flex justify-between items-center bg-white p-2 rounded border border-slate-200/40">
                ...
                <div className="h-full bg-white/90 backdrop-blur-md rounded-[23px] p-6 sm:p-8 flex flex-col justify-between text-left space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-mono text-xs font-bold text-slate-400 tracking-wider">STAGE 02</span>
                    </div>
                  ...
                  {/* High-Fidelity Mockup simulation */}
                  <div className="border border-slate-100 rounded-2xl bg-white p-4 font-mono text-[10px] space-y-3 relative overflow-hidden">
                    <div className="flex justify-between items-center text-slate-450 border-b border-slate-200/50 pb-1.5">
                      <span>QR TICKET GATEWAY</span>
                      <span className="text-accent-blue font-sans font-bold">Scanning</span>
                    </div>
                    <div className="flex items-center justify-center p-2 relative bg-white rounded border border-slate-200/40 h-[48px]">
                      ...
                      <div className="flex items-center space-x-3 w-full">
                        <div className="w-7 h-7 bg-slate-100 rounded border border-slate-200 flex items-center justify-center">
                          <QrCode className="w-5 h-5 text-slate-555" />
                        </div>
                        <div className="text-left font-sans">
                          <div className="font-bold text-[9px] text-slate-800">Elena Rostova</div>
                ...
                <div className="h-full bg-white/90 backdrop-blur-md rounded-[23px] p-6 sm:p-8 flex flex-col justify-between text-left space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-mono text-xs font-bold text-slate-400 tracking-wider">STAGE 03</span>
                    </div>
                  ...
                  <div className="border border-slate-100 rounded-2xl bg-white p-4 font-mono text-[10px] space-y-2.5">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="bg-white p-2 rounded border border-slate-200/40">
